<!-- Generated by scripts/compile-skill-references.py; edit rules/composition/. -->
# React Composition Patterns

**Version 1.0.0**
Engineering (source attribution; locally maintained adaptation)

`rules/composition/` is authoritative. Run `python3 scripts/compile-skill-references.py --check`
from the source repository to verify this snapshot. See [metadata](../rules/composition/metadata.json) for provenance.

Source set SHA-256: `ee293ffec01ca0ae2ce0ea22c5e5d9aecbb7671f0976604388e469bd8bbdfef5`
...
4. [React 19 APIs](#4-react-19-apis)
   - [4.1 Choose Ref and Context APIs for the Supported React Version](#41-choose-ref-and-context-apis-for-the-supported-react-version)
...
Source: [architecture-avoid-boolean-props.md](../rules/composition/architecture-avoid-boolean-props.md)
...
Source: [architecture-compound-components.md](../rules/composition/architecture-compound-components.md)
...
Source: [state-decouple-implementation.md](../rules/composition/state-decouple-implementation.md)
...
Source: [state-context-interface.md](../rules/composition/state-context-interface.md)
...
Source: [state-lift-state.md](../rules/composition/state-lift-state.md)
...
Source: [patterns-explicit-variants.md](../rules/composition/patterns-explicit-variants.md)
...
Source: [patterns-children-over-render-props.md](../rules/composition/patterns-children-over-render-props.md)
...
React 19+ options for ref props and conditional context reads; preserve supported existing APIs and library compatibility.

### 4.1 Choose Ref and Context APIs for the Supported React Version

Source: [react19-no-forwardref.md](../rules/composition/react19-no-forwardref.md)

**Impact: MEDIUM (preserves compatibility while using newer APIs where useful)**
