...
3. **Group findings.** Organize into action groups by file overlap, dependency chains, and shared change patterns - each group is a cohesive unit of work. Carry forward unresolved findings from prior audits.
